...
<div id="add_new_event_modal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <form action="" method="POST" accept-charset="utf-8" class="m-3">
      ...
      <div class="input-group input-group-sm mb-3">
          ...
          <input type="time" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
      </div>
